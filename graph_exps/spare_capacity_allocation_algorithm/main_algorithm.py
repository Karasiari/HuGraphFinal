...
def run_greedy_spare_capacity_allocation(input_data: SpareCapacityGreedyInput) -> SpareCapacityGreedyOutput:
    ...
    for failed_edge_idx in failure_edge_indices:
        ...
        routed.clear()
        compute_leftover_space(leftover, affected_demands, epsilon, instance.demands_by_id)
        compute_leftover_wo_epsilon_space(leftover_wo_epsilon, affected_demands, instance.demands_by_id)
